...
1. use the exact section order defined in [REPORT-FORMAT.md](./REPORT-FORMAT.md),
...
3. Each subagent writes only `<basename>_grading.md` plus
     ...
     defined in [REPORT-FORMAT.md](./REPORT-FORMAT.md). They MUST NOT produce
     free-form reports with different lengths or different structures per
     student.
...
The mandatory `*_grading.md` structure, its section-content requirements, and
the subagent standardization rules are in [REPORT-FORMAT.md](./REPORT-FORMAT.md).
