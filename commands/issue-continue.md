---
description: continue work on an issue
---
continue work on issue $ARGUMENTS

- fetch the issue via "gh issue ... --json" and read its entire content, including comments.
- if you detect any ambiguities, prompt the user
