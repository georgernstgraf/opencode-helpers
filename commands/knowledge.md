...
materials for a technical college in vienna.
...
- make 7-12 multiple choice questions with 1-4 true answers each, referring to the topics that were covered.
- also create 2-3 free-form questions where the student has to answer with free text.
- do not put the solutions into this file, but please:
