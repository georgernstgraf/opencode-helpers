...
- **Tradeoff**: A single shared credential must be deployed to claw/think/dell and rotated by hand; a credential leak reopens the instance. `robots.txt`/noindex already limited indexing, but public reachability was the real problem.
